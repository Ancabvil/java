    ...
    <body>
        ...
        <div class="container">  
            ...
            while (listado_fav.next()) {              
                ...
                ResultSet videojuego_fav = s.executeQuery ("Select * from favorito");
                videojuego_fav.next();                    
            %>
            ...
            <div class="col s4 m4 l4">           
                <div class="card grey lighten-5">
                    <div class="card-image">
                        <img src="<%=videojuego_fav.getString("id_videojuego") %>">
                        <form method="post" action="borraFavorito.jsp">
                            <input type="hidden" name="identificador" value="<%=videojuego_fav.getInt("id_videojuego") %>">
                    ...
                    <div class="card-content">                        
                        <span class="card-title"> <%= listado_fav.getString("id_videojuego")%></span>
                        <p style="text-align:justify">Descripción corta <%= listado_fav.getString("id_usuario")%></p>
                    </div>
                </div>
            </div>
