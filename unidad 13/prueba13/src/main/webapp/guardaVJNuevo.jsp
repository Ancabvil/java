...
<html>
    ...
    <body>
        ...
        // TODO: Ejecución de sentencia SQL y posicionamiento del cursor
        // Comprueba si el identificador del videojuego ya existe            
        String coincidencias = "SELECT identificador FROM videojuego WHERE identificador="
        + Integer.valueOf(request.getParameter("identificador"));      
        ResultSet juegos = s.executeQuery(coincidencias);
        juegos.last();
      
        
        // TODO: Si el videojuego no está en la BBDD, añadirlo
