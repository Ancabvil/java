public class colores {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      consolecolors.CYAN_UNDERLINED + "Writing in Cyan Underline"
    );
    System.out.println(consolecolors.BLUE + "Writing in blue");
    System.out.println(
      consolecolors.GREEN_BACKGROUND + "Writing in green background"
    );
